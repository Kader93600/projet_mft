...
export const PLANS: Plan[] = [
  {
    ...
    // post-activation KYC. À SUPPRIMER après le test (revert du commit).
    id: "test-1e",
    name: "TEST 1€ — Ne pas commander",
    tagline: "Plan de test interne",
    description:
      "Plan technique temporaire pour valider l'intégration Stripe en production après activation KYC. À supprimer après le test.",
    priceCents: 100, // 1 €
    hours: 0,
    durationWeeks: 0,
    modality: "distanciel",
